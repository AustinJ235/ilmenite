...
const ABEEZEE_REGULAR_BYTES: &'static [u8] = include_bytes!("./fonts/ABeeZee-Regular.ttf");

pub struct BstTextParser {
	bytes: &'static [u8],
	otf: OpenTypeFile<'static>,
	head: HeadTable,
	maxp: MaxpTable,
	cmap: Cmap<'static>,
	...
	gpos_op: Option<LayoutTable<GPOS>>,
	gsub_op: Option<LayoutTable<GSUB>>,
}
