...
use basalt::interface::bin::{self, BinPosition, BinStyle, Color};
    ...
    Basalt::initialize(
        ...
        Box::new(move |basalt_res| {
            ...
            tests[5].style_update(BinStyle {
                position: Some(BinPosition::Parent),
                pos_from_t: Some(
                    10.0 + 36.0 + 10.0 + 24.0 + 10.0 + 18.0 + 10.0 + 16.0 + 10.0 + 14.0 + 10.0,
                ),
                pos_from_l: Some(10.0),
                pos_from_r: Some(10.0),
                height: Some(12.0),
            ...
            loop {
                ...
                tests.iter().for_each(|b| {
                    b.style_update(BinStyle {
